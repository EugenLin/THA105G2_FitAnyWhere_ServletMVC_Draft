-- 初始化資料庫
drop database if exists fitanywhereServlet;

-- 重新建立資料庫
create database fitanywhereServlet CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- 選擇資料庫
use fitanywhereServlet;
...
create table course(
    ...
    insert into course(cr_id,u_id,cr_class ,cr_state ,cr_subtitle ,cr_intro ,cr_cover ,cr_price ,cr_create_date ,cr_edit_date ,cr_cm_quan ,cr_tot_star ,cr_purpose_1 ,cr_purpose_2 ,cr_purpose_3 ,cr_pre,cr_target_1 ,cr_hello_msg ,cr_cong ,cr_level )values(1, 10001, '健身', 1, 'Introduction to Programming', 'This course covers the basics of programming.', NULL, 29, '2023-01-01 08:00:00', '2023-01-10 12:30:00', 50, 4, 'Learn Programming', 'Build Web Apps', 'Data Analysis', NULL, 'Beginners', NULL, NULL, 'Normal');
    insert into course(cr_id,u_id,cr_class ,cr_state ,cr_subtitle ,cr_intro ,cr_cover ,cr_price ,cr_create_date ,cr_edit_date ,cr_cm_quan ,cr_tot_star ,cr_purpose_1 ,cr_purpose_2 ,cr_purpose_3 ,cr_pre,cr_target_1 ,cr_hello_msg ,cr_cong ,cr_level )values(2, 10002, '有氧', 1, 'Graphic Design Fundamentals', 'Explore the world of graphic design with hands-on projects.', NULL, 49, '2023-02-15 10:30:00', '2023-02-28 15:45:00', 30, 5, 'Learn Graphic Design', 'Create Stunning Logos', 'Illustration Techniques', NULL, 'Design Enthusiasts', NULL, NULL, 'Normal');
    insert into course(cr_id,u_id,cr_class ,cr_state ,cr_subtitle ,cr_intro ,cr_cover ,cr_price ,cr_create_date ,cr_edit_date ,cr_cm_quan ,cr_tot_star ,cr_purpose_1 ,cr_purpose_2 ,cr_purpose_3 ,cr_pre,cr_target_1 ,cr_hello_msg ,cr_cong ,cr_level )values(3, 10003, '減脂', 1, 'Healthy Cooking Essentials', 'Learn to cook delicious and healthy meals for yourself and your loved ones.', NULL, 39, '2023-03-20 09:15:00', '2023-03-31 14:00:00', 25, 4, 'Healthy Cooking', 'Nutrition Essentials', 'Meal Planning', 'Basic Cooking Skills', 'Health Enthusiasts', NULL, NULL, 'Beginner');
...
create table administrator(
	...
	insert into administrator (am_name , am_password ,am_level)values('andy', 111 ,0);
    insert into administrator (am_name , am_password ,am_level)values('tommy',111 ,1);
    insert into administrator (am_name , am_password ,am_level)values('joy', 111 ,2);
